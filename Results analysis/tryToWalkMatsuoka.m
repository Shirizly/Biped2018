function Sim = tryToWalkMatsuoka(seq,ter_type,varargin)
Dur = 20;
    timestep = 0.01;
...
%         'nAnkle','nHip','maxAnkle', 'maxHip','MutDelta0','MutDelta1');
    ...
    switch nargin
        case 2
            ...
            Sim.Con.nPulses = N;
            Sim.Con.stDim = 4*N;
            Sim.Con = Sim.Con.SetOutMatrix([nAnkle1,nAnkle1,nHip]);
